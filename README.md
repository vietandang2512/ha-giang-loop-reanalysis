...
way. [`R/07_latent_class_check.R`](R/07_latent_class_check.R) fits a latent class
...
response, so anyone can rerun scripts 04 and get my numbers.
...
[`R/07_latent_class_check.R`](R/07_latent_class_check.R) rather than pulling in
...
Rscript R/07_latent_class_check.R  # robustness check on script 03
```
